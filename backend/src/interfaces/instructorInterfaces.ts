import { EventDTO, ICourseDetailsDTO, InstructorCourseDTO } from "../dto/instructorDTO";
...
export interface IEventResultService {
  events: EventDTO[];
  totalPages: number;
  currentPage: number;
}
...
export interface IEventDetailsService {
  event: EventDTO;
}
